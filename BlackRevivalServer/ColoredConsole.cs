...
namespace BlackRevivalServer
{
    ...
    public static class ColorConsole
    {
        ...
        /// <param name="OverrideLen">Allows you to set the len of the wrapper char</param>
                                                ...
                                                int OverrideLen = 0)
        {
            ...
            string line;
            if (OverrideLen == 0)
                line = new string(wrapperChar, headerText.Length);
            else
                line = new string(wrapperChar, OverrideLen);
